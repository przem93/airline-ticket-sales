...
export default class EditFlightView extends React.Component {
    constructor(props) {
        super(props);
                ...
                <Card>
                    <Card.Content>
                        ...
                        <Row>
                            ...
                            <Col s={4}>
                                <label>Godzina</label>
                                <select onChange={::this.changeHour} value={this.state.hour}>
                    ...
                    <Card.Action>
                        <a onClick={::this.editFlight}>Dodaj przelot</a>
                    </Card.Action>
                </Card>
            </Col>
        </Row>;
